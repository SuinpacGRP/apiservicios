...
public function guardarLectura(Request $request){
    ...
    $obtenTarifa =PresidentesPrueba::ObtenConsumo($tipoToma[0]->TipoToma, $dConsumoFinal, $dIdCliente, $dAnioCaptura);//Mensaje 223 campos incorrectos
...
function ObtenConsumo($TipoToma, $Cantidad, $Cliente, $ejercicioFiscal){
	...
	$ConfiguracionCalculo= PresidentesPrueba::ObtenValorPorClave("CalculoAgua", $Cliente);
	...
	return PrecidentesPrueba::truncateFloat($ImporteTotal,2);
	...
	}else
	{
		...
		return PresidentesPrueba::truncateFloat($ImporteTotal,2);
