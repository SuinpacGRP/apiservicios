...
class Wkhtmltopdf
{
    ...
    protected $_headerrStyle = null;
    protected $_footerStyleLeft = null;
    protected $_footerStyleCenter = null;
    protected $_headerStyleCenter = null;
    protected $_headerStyleLeft = null;
    protected $_headerStyleRight = null;

    protected $_pageSize = null;
    /* Bloque 1 agregado Edgar*/
    protected $_pageHeight = null;
    protected $_pageWidth = null;
    /*Terminacion del bloque 1*/
     ...
     * Path to executable.
     */
    protected $_bin = '/usr/local/bin/wkhtmltopdf';
	 ...
	 */
	 const FOOTER_STYLE = 'NO USE';
	 const HEADER_STYLE = 'NO USE';
    ...
    public function __construct(array $options = array())
    {
        ...
        if (array_key_exists('FooterStyleLeft', $options)) {
            $this->setFooterStyleLeft($options['FooterStyleLeft']);
        } else {
            $this->setFooterStyleLeft(self::FOOTER_STYLE);
        }
        if (array_key_exists('FooterStyleRight', $options)) {
            $this->setFooterStyleRight($options['FooterStyleRight']);
        } else {
            $this->setFooterStyleRight(self::FOOTER_STYLE);
        }
        if (array_key_exists('FooterStyleCenter', $options)) {
            $this->setFooterStyleCenter($options['FooterStyleCenter']);
        } else {
            $this->setFooterStyleCenter(self::FOOTER_STYLE);
        }

		if (array_key_exists('HeaderStyleLeft', $options)) {
            $this->setHeaderStyleLeft($options['HeaderStyleLeft']);
        } else {
            $this->setHeaderStyleLeft(self::HEADER_STYLE);
        }
        if (array_key_exists('HeaderStyleRight', $options)) {
            $this->setHeaderStyleRight($options['HeaderStyleRight']);
        } else {
            $this->setHeaderStyleRight(self::HEADER_STYLE);
        }
        if (array_key_exists('HeaderStyleCenter', $options)) {
            $this->setHeaderStyleCenter($options['HeaderStyleCenter']);
        } else {
            $this->setHeaderStyleCenter(self::HEADER_STYLE);
        }
		
		if (array_key_exists('HeaderStyle', $options)) {
            $this->setHeaderStyle($options['HeaderStyle']);
        } else {
            $this->setHeaderStyle(self::HEADER_STYLE);
        }
        ...
        if (array_key_exists('page_size', $options)) {
            ...
            $this->setPageSize(self::SIZE_LETTER);
        }
        ...
        if (array_key_exists('lowquality', $options)) {
            $this->setlowquality($options['lowquality']);
        }

        if (!array_key_exists('path', $options)) {
            throw new Exception("Path to directory where to store files is not set");
        }
 		if (array_key_exists('copies', $options)) {
            $this->setCopies($options['copies']);
        }
        
        /*Bloque 2*/
        
         if (array_key_exists('page_height', $options)) {
           $this->setPageHeight($options['page_height']);
        }else {
            $this->setPageHeight(self::PAGE_HEIGHT);
        }
        
        if (array_key_exists('page_width', $options)) {
            $this->setPageWidth($options['page_width']);
        }else {
            $this->setPageWidth(self::PAGE_WIDTH);
        }
	...
	public function setFooterStyleLeft($style)
    {
        $this->_footerStyleLeft = (string)$style;
        return $this;
    }
	
	public function getFooterStyleLeft()
    {
        return $this->_footerStyleLeft;
    }
    
    public function setFooterStyleRight($style)
    {
        $this->_footerStyleRight = (string)$style;
        return $this;
    }
	
	public function getFooterStyleRight()
    {
        return $this->_footerStyleRight;
    }
	
	public function setFooterStyleCenter($style)
    {
        $this->_footerStyleCenter = (string)$style;
        return $this;
    }
    public function getFooterStyleCenter()
    {
        return $this->_footerStyleCenter;
    }


	public function setHeaderStyleLeft($style)
    {
        $this->_headerStyleLeft = (string)$style;
        return $this;
    }
	
	public function getHeaderStyleLeft()
    {
        return $this->_headerStyleLeft;
    }
    
    public function setHeaderStyleRight($style)
    {
        $this->_headerStyleRight = (string)$style;
        return $this;
    }
	
	public function getHeaderStyleRight()
    {
        return $this->_headerStyleRight;
    }
	
	public function setHeaderStyleCenter($style)
    {
        $this->_headerStyleCenter = (string)$style;
        return $this;
    }

	
	public function getHeaderStyleCenter()
    {
        return $this->_headerStyleCenter;
    }
	
	public function setHeaderStyle($style)
    {
        $this->_headerStyle = (string)$style;
        return $this;
    }
    ...
    public function getCopies()
    {
        ...
        /**
     * Establece el Ancho Personalizado
     *
     * @author aur1mas <ovandome@gmail.com>
     * @param int $PageWidth
     * @return Wkthmltopdf
     */
    public function getPageWidth()
    {
     ...
     /**
     * Establece el Largo Personalizado
     *
     * @author aur1mas <aur1mas@devnet.lt>
     * @param int $copies
     * @return Wkthmltopdf
    ...
    {
        $this->_PageHeight = (int)$pageheight;
        return $this;
    }
	...
	public function setlowquality($lowquality = true)
    {
        $this->_lowquality = (boolean)$lowquality;
        return $this;
    }
    ...
    protected function _getCommand()
    {
        ...
        /*Bloque 3*/
        if($this->getPageHeight()!=0)
        $command .= " --page-height " . $this->getPageHeight();
          if($this->getPageWidth()!=0)
        $command .= " --page-width " . $this->getPageWidth();
        ...
        $command .= ($this->getlowquality()) ? " --lowquality" : "";
		$command .= ($this->getFooterStyleLeft()!="NO USE")?' --footer-left "'.$this->getFooterStyleLeft().'" 	--footer-font-size 8':"";
		$command .= ($this->getFooterStyleRight()!="NO USE")?' --footer-right "'.$this->getFooterStyleRight().'" 	--footer-font-size 8':"";
		$command .= ($this->getFooterStyleCenter()!="NO USE")?' --footer-center "'.$this->getFooterStyleCenter().'" 	--footer-font-size 8':"";
		$command .= ($this->getHeaderStyleLeft()!="NO USE")?' --header-left "'.$this->getHeaderStyleLeft().'" 	--header-font-size 8':"";
		$command .= ($this->getHeaderStyleRight()!="NO USE")?' --header-right "'.$this->getHeaderStyleRight().'" 	--header-font-size 8':"";
		$command .= ($this->getHeaderStyleCenter()!="NO USE")?' --header-center "'.$this->getHeaderStyleCenter().'" 	--header-font-size 8':"";
		$command .= ($this->getHeaderStyle()!="NO USE")?' --header-right "'.$this->getHeaderStyle().'" 	--header-font-size 8':"";
		#$command .= ' --load-media-error-handling ignore ';
        $command .= ' "%input%"';
        $command .= " -";
    ...
    public function obtieneComando($ruta)
    {
        ...
        $content = str_replace('%input%', $input, $this->_getCommand() );
    ...
    protected function _render()
    {
		...
		#echo str_replace('%input%', $input, $this->_getCommand());exit;
